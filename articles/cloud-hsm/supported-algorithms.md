...
|-----------|--------------|
| AES (non-compliant) | Key wrap (TR31/TR34/AES-CBC/AES-GCM, wrap/unwrap), DecimalTable/Data/PIN Encryption/Decryption. FF1/FF3-1 Data Encryption/Decryption<br>• AES GCM supports the IV length from 1 byte to 16 bytes |
...
| ECDSA (non-compliant) | Key generation, Sign, Verify<br>P192, Secp192k1, brainpoolP160r1, brainpool192r1, K-163 and B-163<br>(SHA-1, SHA-224, SHA-256, SHA-384, SHA-512) |
