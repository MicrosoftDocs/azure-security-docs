...
- **Azure Kubernetes Service**: You can use it to host applications that interact with Azure confidential ledger. It has its own regional deployment and data storage considerations.
