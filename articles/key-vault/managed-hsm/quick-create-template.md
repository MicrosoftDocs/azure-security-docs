...
This quickstart describes how to use an Azure Resource Manager template (ARM template) to create an Azure Key Vault managed HSM. [!INCLUDE [Managed HSM description](../includes/managed-hsm/intro.md)]  
