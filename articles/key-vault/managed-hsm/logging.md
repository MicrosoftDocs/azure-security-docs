...
* An existing Log Analytics workspace. You can create one using the steps found in [Create Log Analytics workspaces](/azure/azure-monitor/logs/quick-create-workspace?tabs=azure-portal).
