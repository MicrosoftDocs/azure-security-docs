...
1.	If you want to allow Microsoft Trusted Services to bypass the Managed HSM Firewall, select **Yes**. For a full list of the current Managed HSM Trusted Services, see [Azure Key Vault Trusted Services](https://learn.microsoft.com/azure/key-vault/general/overview-trusted-services).
1.	Select **Save**.
