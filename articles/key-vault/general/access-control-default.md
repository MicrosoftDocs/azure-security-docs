...
> [!IMPORTANT]
> All Key Vault control plane API versions before 2026-02-01 retire on February 27, 2027. Your key vaults will continue to exist and only be accessible with control plane API versions 2026-02-01 or later. Data plane APIs are not affected.
