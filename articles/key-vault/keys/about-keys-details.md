...
>
> Microsoft does **not** recommend RSA_1_5 and RSA_OAEP, which aare included solely for backwards compatibility. Cryptographic standards no longer consider RSA with the PKCS#1 v1.5 padding scheme secure for encryption, while RSA_OAEP utilizes SHA1, which has known collision problems with SHA1. 
