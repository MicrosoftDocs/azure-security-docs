...
If our monitoring detects a genuine PSU issue, Microsoft replaces it without requiring customer action or notification. PSU hot-swap is performed without causing a tamper event.
